...
public class LSL {
     ...
     * @return An array of stream info RDA (excluding their desc field), any of which can
     ...
     * @return An array of matching stream info RDA (excluding their meta-data), any of
